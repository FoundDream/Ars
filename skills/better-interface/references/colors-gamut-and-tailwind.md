...
- [sRGB vs Display P3](#srgb-vs-display-p3)
- [Maximum chroma](#max-chroma-varies-by-lightness-and-hue)
- [Gamut checking](#gamut-checking)
- [CSS fallback patterns](#css-fallback-patterns)
