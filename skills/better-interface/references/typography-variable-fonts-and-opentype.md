...
- [Static vs variable](#static-vs-variable)
- [Load intended weights and styles](#load-intended-weights-and-styles)
- [Axes](#axes)
- [Properties over axis tags](#properties-over-axis-tags)
- [OpenType features](#opentype-features)
- [Small caps, superscripts, and subscripts](#small-caps-superscripts-subscripts)
- [Stylistic sets and character variants](#stylistic-sets-and-character-variants)
