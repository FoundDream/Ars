...
- [Skip link](#skip-link)
- [Tabindex rules](#tabindex-rules)
- [Focus trapping and restoration](#focus-trapping-and-restoration)
- [Keyboard patterns](#keyboard-patterns-aria-apg)
- [SPA route changes](#spa-route-changes)
