...
- [Breathing room between targets](#breathing-room-between-targets)
- [Inset buttons from the edges](#inset-buttons-from-the-edges)
- [Progressive disclosure](#progressive-disclosure-needs-an-affordance)
- [Content bleeds, controls float](#content-bleeds-controls-float)
- [Hold structure until it breaks](#hold-structure-until-it-breaks)
- [Plan for growth and clipping](#plan-for-growth-and-clipping)
...
WCAG target-size requirements, larger usability targets, and pseudo-element expansion are covered by the Accessibility domain; these clearances are in addition, so expanded hit areas never overlap.
...
- **Truncation cues.** Clamped text shows an ellipsis and a way to expand; see the Typography domain for truncation mechanics.
