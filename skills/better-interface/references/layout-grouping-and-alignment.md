...
- [Group with space, not lines](#group-with-space-not-lines)
- [Keep controls distinct from content](#keep-controls-distinct-from-content)
- [Align to shared edges](#align-to-shared-edges)
- [Logical properties, not physical](#logical-properties-not-physical)
- [Order by importance](#order-by-importance)
- [Do not overload the entry point](#dont-overload-the-entry-point)
...
- Numbers in tables right-align to the trailing edge (see the Typography domain for tabular figures); text left-aligns to the leading edge.
...
- One primary action per view (see the Colors domain for how color enforces this).
